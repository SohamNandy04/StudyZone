            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Comprehensive Guide to DBMS: Tools, Techniques, and Best Practices</h4>
                        <p className="card-text">Learn the core principles of database management systems, including database design, implementation, and optimization techniques, to effectively manage and utilize data for various applications.</p>

            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Comprehensive Guide to Machine Learning: Algorithms, Tools, and Applications</h4>
                        <p className="card-text">Explore machine learning concepts, techniques, and algorithms to build, train, and deploy models that can make predictions and automate decision-making processes.</p>

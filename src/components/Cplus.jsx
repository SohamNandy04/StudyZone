            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Mastering C++</h4>
                        <p className="card-text">Master the fundamentals and advanced concepts of C++ programming to develop efficient and high-performance software applications.</p>

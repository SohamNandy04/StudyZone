            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Python Programming: Comprehensive Guide for Developers</h4>
                        <p className="card-text">Learn Python programming from the basics to advanced techniques, covering essential concepts and practical applications to build powerful and efficient software solutions.</p>

            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Mastering C#: From Basics to Advanced Programming</h4>
                        <p className="card-text">Explore C# programming from the ground up, mastering syntax, object-oriented principles, and advanced features to create robust and scalable applications for the .NET framework.</p>

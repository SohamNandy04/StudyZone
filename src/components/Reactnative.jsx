            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Mastering React Native</h4>
                        <p className="card-text">Master React Native to develop high-performance, cross-platform mobile applications for both iOS and Android using JavaScript and React.</p>

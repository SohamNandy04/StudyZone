            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Data Science Essentials: Build Skills for Data-Driven Decision Making</h4>
                        <p className="card-text">Delve into data science with a focus on data analysis, statistical modeling, machine learning, and data visualization to extract actionable insights and make data-driven decisions.</p>

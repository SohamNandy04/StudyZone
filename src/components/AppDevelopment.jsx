            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">The Ultimate Guide to Mobile App Development</h4>
                        <p className="card-text">Learn to design, develop, and deploy mobile applications for iOS and Android from scratch using industry-standard tools and techniques.</p>

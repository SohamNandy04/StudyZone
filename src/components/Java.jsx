            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Java Bootcamp: Learn to Code with Java</h4>
                        <p className="card-text">Learn Java programming from basics to advanced concepts and build robust, scalable applications using one of the most popular programming languages.</p>

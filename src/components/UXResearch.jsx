            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Introduction to UX Research</h4>
                        <p className="card-text">A course that covers essential concepts, methodologies, and tools involved in conducting user experience research. Learn how to create better products by understanding your target audience.</p>

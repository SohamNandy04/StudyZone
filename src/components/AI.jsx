            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Artificial Intelligence for Beginners: Understand and Implement AI Techniques</h4>
                        <p className="card-text">Discover the fundamentals of artificial intelligence, including key algorithms, machine learning techniques, and real-world applications, to create intelligent systems and solve complex problems.</p>

            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Photoshop Essentials: Learn to Edit and Enhance Images Professionally</h4>
                        <p className="card-text">Master Adobe Photoshop for graphic design and photo editing. Learn to use Photoshop tools for creating and manipulating digital images. Skills gained include graphic design, communication, and computer graphic techniques</p>

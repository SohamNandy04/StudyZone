            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Data Analytics for Beginners: Learn to Analyze and Visualize Data</h4>
                        <p className="card-text">Learn the core principles and techniques of data analytics, including data collection, analysis, and visualization, to uncover insights and support informed decision-making.</p>

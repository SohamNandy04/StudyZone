            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Advanced Adobe After Effects: Become VFX & Motion Expert</h4>
                        <p className="card-text">This comprehensive course focuses on advanced techniques and workflows to create stunning visual effects (VFX) and captivating motion graphics. Elevate your projects with expert-level skills.</p>

            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Cyber Security for Beginners: Understand and Implement Protection Measures</h4>
                        <p className="card-text">Explore the fundamentals of cyber security, including threat identification, risk management, and protection strategies, to safeguard digital assets and defend against cyber attacks.</p>

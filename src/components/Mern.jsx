            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Web Development with MERN Stack</h4>
                        <p className="card-text">Learn to build dynamic websites with Mongo DB, Express JS, React JS and Node JS from scratch.</p>

            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Data Structures and Algorithms Essentials: Build Efficient Solutions</h4>
                        <p className="card-text">Explore data structures and algorithms in depth, learning how to optimize code, solve complex problems, and enhance performance with practical examples and real-world applications.</p>

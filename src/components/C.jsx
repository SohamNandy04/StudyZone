            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Fundamentals of C: Develop High-Performance Software</h4>
                        <p className="card-text">Learn the fundamentals of C programming, including syntax, control structures, and memory management, to develop efficient and high-performance applications.</p>

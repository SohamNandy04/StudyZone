            ...
            <div className="course-container">
                <div className="course-details card">
                    <div className="card-body">
                        <h4 className="card-title">Web Development with React JS</h4>
                        <p className="card-text">Learn to build dynamic, responsive web applications using React JS, the popular JavaScript library for creating user interfaces.</p>
